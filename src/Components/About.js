  ...
  return (
    <div className='about-container'>
      ...
      <div className='about-text'>
         <p>I am a software engineer based in Seattle, WA and a lifelong learner working to expand my software development experience.</p>
         ...
         <p>I am self-taught in web development including JavaScript, HTML, CSS, Node.js, React, Git, Github, and basic SQL.</p>
